...
import com.jn.iyuba.concept.simple.presenter.login.WxLoginPresenter;
...
public class WxLoginActivity extends AppCompatActivity implements WxLoginContract.WxLoginView {
    ...
    private String wxKey = "wxf98d71b9618b19f3";
    ...
    public void getWxAppletToken(WxLoginBean wxLoginBean) {
        ...
        req.userName = "gh_a8c17ad593be"; // 填小程序原始id
        req.path = "/subpackage/getphone/getphone?token=" + wxLoginBean.getToken() + "&appid=" + Constant.APPID;
    ...
    public void getUserInfo(MoreInfoBean moreInfoBean, String uid) {
        ...
        userBean.setExpireTime(moreInfoBean.getExpireTime());
