...
public class ExerciseDataWork extends Worker {

    public ExerciseDataWork(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        DataUtil.addExerciseDta(getApplicationContext().getAssets(), "exercise.json");
