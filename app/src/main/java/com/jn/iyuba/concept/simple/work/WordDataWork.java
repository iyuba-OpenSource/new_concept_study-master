...
public class WordDataWork extends Worker {

    public WordDataWork(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        DataUtil.addWordData(getApplicationContext().getAssets(), "conceptword.json");
