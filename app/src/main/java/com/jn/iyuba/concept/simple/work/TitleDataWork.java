...
public class TitleDataWork extends Worker {

    public TitleDataWork(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        DataUtil.addTitleDta(getApplicationContext().getAssets(), "title.json");
