...
import com.jn.iyuba.concept.simple.model.me.SettingModel;
...
public class SettingPresenter extends BasePresenter<SettingContract.SettingView, SettingContract.SettingModel>
        implements SettingContract.SettingPresenter {

    private int page = 1;

    @Override
    protected SettingContract.SettingModel initModel() {
    ...
    public void getStudyRecordByTestMode(String format, int uid, int Pageth, int NumPerPage, int TestMode, String sign, String Lesson) {
        ...
        Disposable disposable = model.getStudyRecordByTestMode(format, uid, Pageth, NumPerPage, TestMode, sign, Lesson, new SettingContract.Callback() {
            @Override
    ...
    public void getTestRecord(String userId, String newstype) {
        ...
        Disposable disposable = model.getTestRecord(userId, newstype, new SettingContract.SyncEvalCallback() {
            @Override
...
//                    DecimalFormat dF00 = new DecimalFormat("#00");
    ...
    public void getExamDetail(int appId, String uid, String lesson, String TestMode, int mode, String sign, String format) {
        ...
        Disposable disposable = model.getExamDetail(appId, uid, lesson, TestMode, mode, sign, format, new SettingContract.SyncWordCallback() {
            @Override
    ...
    public void getTestRecordDetail(String appId, String uid, String TestMode, String sign, String format, String Pageth, String NumPerPage) {
        ...
        Disposable disposable = model.getTestRecordDetail(appId, uid, TestMode, sign, format, Pageth, NumPerPage, new SettingContract.SyncExerciseCallback() {
            @Override
    ...
    public void islatest(String url, int currver, String packageStr) {
        ...
        Disposable disposable = model.islatest(url, currver, packageStr, new SettingContract.LatestCallback() {
            @Override
